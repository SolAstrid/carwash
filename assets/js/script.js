...
function valida_envia(){
    ...
    //valido el digito
    if (document.fvalida.digidv.value.length==0){
        alert("Tiene que escribir su Digito Verificador")
        document.fvalida.digidv.focus()
        return 0
     }else{
          const digive = dgv(fvalida.rut.value) 
        if (fvalida.digidv.value!=digive){
    ...
    //valido la direccion
    if (document.fvalida.dire.value.length==0){
        alert("Tiene que escribir su Dirección")
        document.fvalida.dire.focus()
        return 0;
 }
    ...
    if (document.fvalida.regiones.selectedIndex==0){
        ...
        document.fvalida.regiones.focus()
        return 0;
 }
    ...
    if (document.fvalida.comunas.selectedIndex==0){
        ...
        document.fvalida.comunas.focus()
        return 0;
 }
    ...
    //valido el año
    if (document.fvalida.typeano.selectedIndex==0){
        alert("Tiene que seleccionar el Año de su Vehiculo")
        document.fvalida.typeano.focus()
        return 0;
 }

    //valido revision tecnica
    if (document.fvalida.typerevi.selectedIndex==0){
        alert("Debe seleccionar revision tecnica.")
        document.fvalida.revi.focus()
        return 0;0
 }
    ...
    //valido encargado
    if (document.fvalida.typeenca.selectedIndex==0){
        alert("Debe seleccionar Encargado.")
        document.fvalida.typeenca.focus()
        return 0;0
 }
